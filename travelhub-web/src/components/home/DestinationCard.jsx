...
function DestinationCard({ name, country, priceFrom, rating, background }) {
  ...
  return (
    <article className="destination-card" style={{ background }}>
      <div className="destination-card__inner">
        ...
        <div className="destination-card__meta">
          <span className="destination-card__price">
            {t("hotelDetail.destinationFrom", { price: priceFrom })}
          </span>
          <span
            className="destination-card__rating"
            aria-label={t("hotelDetail.destinationRatingAria", { rating: formattedRating })}
          >
